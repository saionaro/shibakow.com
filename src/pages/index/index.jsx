        ...
        {(locale) => (
          <div className="person" itemScope itemType="http://schema.org/Person">
            <header className="head">
              <img className="photo" itemProp="image" src="/img/photo.jpg" alt={locale.imageAlt} height="200" width="200" />
              <h1 className="name" itemProp="name" title={locale.name}>{locale.name}</h1>
            </header>
            <main className="contacts">
              <a className="contacts__item" itemProp="email" href="mailto:shibakow@gmail.com">
              ...
              <a className="contacts__item contacts__item--fav" itemProp="sameAs" href="https://t.me/shibakow" target="_blank" rel="nofollow noopener noreferrer">
              ...
              <a className="contacts__item" itemProp="sameAs" href="https://github.com/saionaro" target="_blank" rel="nofollow noopener noreferrer">
              ...
              <a className="contacts__item" itemProp="sameAs" href={locale.socnetRef} target="_blank" rel="nofollow noopener noreferrer">
              ...
              <a className="contacts__item" href={locale.locationRef} target="_blank" rel="nofollow noopener noreferrer">
